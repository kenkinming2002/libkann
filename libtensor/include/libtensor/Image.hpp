...
{
  template<typename T>
  LIBTENSOR_EXPORT Tensor<T> image2d_cross_correlate(Tensor<const T> inputs, bool trans_inputs, Tensor<const T> kernels, bool trans_kernels, Vec2 output_size);

  template<typename T>
  LIBTENSOR_EXPORT Tensor<T> image2d_convolve(Tensor<const T> inputs, bool trans_inputs, Tensor<const T> kernels, bool trans_kernels, Vec2 output_size);

  extern template LIBTENSOR_EXPORT Tensor<float>       image2d_cross_correlate(Tensor<const float>       inputs, bool trans_inputs, Tensor<const float>       kernels, bool trans_kernels, Vec2 output_size);
  extern template LIBTENSOR_EXPORT Tensor<double>      image2d_cross_correlate(Tensor<const double>      inputs, bool trans_inputs, Tensor<const double>      kernels, bool trans_kernels, Vec2 output_size);
  extern template LIBTENSOR_EXPORT Tensor<long double> image2d_cross_correlate(Tensor<const long double> inputs, bool trans_inputs, Tensor<const long double> kernels, bool trans_kernels, Vec2 output_size);

  extern template LIBTENSOR_EXPORT Tensor<float>       image2d_convolve(Tensor<const float>       inputs, bool trans_inputs, Tensor<const float>       kernels, bool trans_kernels, Vec2 output_size);
  extern template LIBTENSOR_EXPORT Tensor<double>      image2d_convolve(Tensor<const double>      inputs, bool trans_inputs, Tensor<const double>      kernels, bool trans_kernels, Vec2 output_size);
  extern template LIBTENSOR_EXPORT Tensor<long double> image2d_convolve(Tensor<const long double> inputs, bool trans_inputs, Tensor<const long double> kernels, bool trans_kernels, Vec2 output_size);
}
