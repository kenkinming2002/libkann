...
namespace kann
{
  ...
  {
  public:
    virtual std::shared_ptr<const Variable> invoke(std::vector<std::shared_ptr<const Variable>> inputs) const = 0;
  ...
  {
  public:
    std::shared_ptr<const Variable> invoke(std::vector<std::shared_ptr<const Variable>> inputs) const override final
    {
