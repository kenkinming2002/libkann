...
namespace kann
{
  ...
  KANN_EXPORT tensor::Tensor<float> load_mnist_dataset_images_single(const char* file_name);
  KANN_EXPORT tensor::Tensor<float> load_mnist_dataset_labels_single(const char* file_name);
}
