...
namespace kann
{
  ...
  std::vector<tensor_t> Layer::get_parameters_all() const { return get_attribute_all(*this, &Layer::parameters, def->parameters_all_count()); }
  std::vector<tensor_t> Layer::get_states_all()     const { return get_attribute_all(*this, &Layer::states,     def->states_all_count()); }
}
