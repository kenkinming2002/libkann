...
namespace kann
{
  ...
  {
    YAML::Node node;
    node["input_width"]          = std::static_pointer_cast<const ConvolutionalLayerDef>(layer_def)->m_input_width;
    node["input_height"]         = std::static_pointer_cast<const ConvolutionalLayerDef>(layer_def)->m_input_height;
    node["kernel_size"]          = std::static_pointer_cast<const ConvolutionalLayerDef>(layer_def)->m_kernel_size;
  ...
  KANN_LAYER_DEF_SAVE_LOAD_REGISTER(convolution, ConvolutionalLayerDef)
