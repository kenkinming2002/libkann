...
namespace kann
{
  ...
  Tensor MatrixProductOperation::processImpl(const Tensor& a, const Tensor& b) const
  {
  ...
  std::pair<variable_t, variable_t> MatrixProductOperation::gradientsImpl(variable_t gradient, variable_t a, variable_t b) const
  {
