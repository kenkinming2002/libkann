...
namespace kann
{
  ...
  Eigen::VectorXd DeconvolutionalLayer::feedForward(const Eigen::VectorXd& input)
  {
  ...
  Eigen::RowVectorXd DeconvolutionalLayer::backPropagate(const Eigen::VectorXd& input, const Eigen::RowVectorXd& outputGradient)
  {
