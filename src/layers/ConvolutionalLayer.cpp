...
namespace kann
{
  ...
  Eigen::VectorXd ConvolutionalLayer::feedForward(const Eigen::VectorXd& input)
  {
  ...
  Eigen::RowVectorXd ConvolutionalLayer::backPropagate(const Eigen::VectorXd& input, const Eigen::RowVectorXd& outputGradient)
  {
